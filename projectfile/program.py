...
known_face_encoding = [jobs_encoding, ratan_tata_encoding, sadmona_encoding, tesla_encoding, Amandeep_encoding]

known_faces_names = ["jobs", "ratan tata", "sadmona", "tesla", "Amandeep paji"]
